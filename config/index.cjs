...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxbf21be2b13748676',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'de1ea0107a49141a284c9c14fb321e63',
  ...
  USERS: [
    {
      ...
      id: 'oprQy50tZjFVCvdkS3KUyTLgqGno',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '	P6ULdccW5RA_5T3Ywds5f6ubyz9L7gupdxdtSHu8wPo',
      // 所在省份
      province: '贵州',
      // 所在城市
      city: '贵阳',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '熊媛媛', year: '2000', date: '10-06',
        },
        {
          type: '节日', name: '恋爱纪念日', year: '2021', date: '06-12',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '王', year: '2000', date: '06-18',
        },
        {
          type: '节日', name: '相识纪念日', year: '2021', date: '05-12',
        }
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2021-06-012' }
      ],
      // 课程表相关配置
  ...
  CALLBACK_TEMPLATE_ID: '	gYKLdRz1rRDPsoJTXo4i49a5EgAMkUQimUad2BNxJac',
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'oprQy515uNsiHyg5dRYpXr7DOfkI',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
